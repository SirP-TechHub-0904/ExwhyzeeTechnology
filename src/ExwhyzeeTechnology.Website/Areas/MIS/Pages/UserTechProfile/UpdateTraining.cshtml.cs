...
namespace ExwhyzeeTechnology.Website.Areas.MIS.Pages.UserTechProfile
{
    ...
    public class UpdateTrainingModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            getform.EmploymentStatus = TrainingApplicationForm.EmploymentStatus;
            getform.NatureOfJob = TrainingApplicationForm.NatureOfJob;
            getform.MonthlyIncome = TrainingApplicationForm.MonthlyIncome;
