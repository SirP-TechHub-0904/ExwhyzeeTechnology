...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class InterestModel : PageModel
    {
        ...
        public InterestModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string? id)
        {
            ...
            ProfileCategories = await _context.ProfileCategories.Where(x => x.Title.ToUpper().Contains("INTEREST"))
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Interest", new { id = AdditionalProfileData.ProfileId });
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            ...
            user.UpdateInterest = false;
            await _userManager.UpdateAsync(user);
            TempData["success"] = "Successfull";

           
                return RedirectToPage("./Interest", new { id = user.Id });
