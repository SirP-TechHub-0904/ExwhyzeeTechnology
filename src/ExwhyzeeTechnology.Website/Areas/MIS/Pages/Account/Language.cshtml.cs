...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class LanguageModel : PageModel
    {
        ...
        public LanguageModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string? id)
        {
            ...
            ProfileCategories = await _context.ProfileCategories.Where(x => x.Title.ToUpper().Contains("LANGUAGES"))
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Language", new { id = AdditionalProfileData.ProfileId });
        }
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            ...
            user.UpdateLanguage = false;
            await _userManager.UpdateAsync(user);
            TempData["success"] = "Successfull";

             
                return RedirectToPage("./Language", new { id = user.Id });
