...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class ExperienceModel : PageModel
    {
        ...
        public ExperienceModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string? id)
        {
            ...
            ProfileCategories = await _context.ProfileCategories.Where(x => x.Title.ToUpper().Contains("EXPERIENCE"))
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Experience", new { id = AdditionalProfileData.ProfileId });
        }
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            ...
            user.UpdateExperience = false;
            await _userManager.UpdateAsync(user);
            TempData["success"] = "Successfull";

            
                return RedirectToPage("./Experience", new { id = user.Id });
