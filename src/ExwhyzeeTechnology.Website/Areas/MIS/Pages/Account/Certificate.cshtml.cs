...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class CertificateModel : PageModel
    {
        ...
        public CertificateModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string? id)
        {
            ...
            ProfileCategories = await _context.ProfileCategories.Where(x => x.Title.ToUpper().Contains("CERTIFICATIONS"))
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Certificate", new { id = AdditionalProfileData.ProfileId });
        }
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            ...
            user.UpdateCertificate = false;
            await _userManager.UpdateAsync(user);
            TempData["success"] = "Successfull";

           
                return RedirectToPage("./Certificate", new { id = user.Id });
