...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class AwardsModel : PageModel
    {
        ...
        private readonly UserManager<Profile> _userManager;
          public AwardsModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager )
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string? id)
        {
            ...
            ProfileCategories = await _context.ProfileCategories.Where(x=>x.Title.ToUpper().Contains("AWARDS"))
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Awards", new { id = AdditionalProfileData.ProfileId });
        }
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            ...
            user.UpdateAwards = false;
            await _userManager.UpdateAsync(user);


            TempData["success"] = "Successfull";
 
                return RedirectToPage("./Awards", new { id = user.Id });
