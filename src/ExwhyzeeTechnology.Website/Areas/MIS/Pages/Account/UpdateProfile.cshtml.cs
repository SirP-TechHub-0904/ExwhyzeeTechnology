...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class UpdateProfileModel : PageModel
    {
        ...
        public UpdateProfileModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager, IConfiguration config, IStorageService storageService)
        {
            _context = context;
