...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class ReferenceModel : PageModel
    {
        ...
        public ReferenceModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Reference", new { id = AdditionalProfileData.ProfileId });
        }
