...
namespace ExwhyzeeTechnology.Website.Areas.Account.Pages.Account
{
    ...
    public class SkillsModel : PageModel
    {
        ...
        public SkillsModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string? id)
        {
            ...
            ProfileCategories = await _context.ProfileCategories.Where(x => x.Title.ToUpper().Contains("SKILLS"))
        ...
        public async Task<IActionResult> OnPostAdditionalAsync()
        {
            ...
            return RedirectToPage("./Skills", new { id = AdditionalProfileData.ProfileId });
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            ...
            user.UpdateSkills = false;
            await _userManager.UpdateAsync(user);

            TempData["success"] = "Successfull";

            
                return RedirectToPage("./Skills", new { id = user.Id });
