...
namespace ExwhyzeeTechnology.Website.Areas.Student.Pages.UserTechProfile
{
    ...
    public class UpdateTrainingModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostCloseAsync()
        {
            ...
            return RedirectToPage("./UpdateTraining", new { id = getform.Id, apid = Guid.NewGuid(), stage = "xmbtxmbt", process = Guid.NewGuid() });
        }
    }
